...
class ResColors {
  ...
  static const Color tealThemeDarkPrimary = Color(0xFF00796B);
  static const Color tealThemeLightPrimary = Color(0xFFB2DFDB);
  static const Color tealThemePrimary = Color(0xFF009688);
  static const Color tealThemeTextAndIcons = Color(0xFFFFFFFF);
  static const Color tealThemeAccent = Color(0xFF03A9F4);
  static const Color tealThemePrimaryText = Color(0xFF212121);
  static const Color tealThemeSecondaryText = Color(0xFF757575);
  static const Color tealThemeDivider = Color(0xFFBDBDBD);
}
